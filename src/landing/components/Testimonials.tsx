...
// (some run the same signals on other platforms too). Cycled across cards
// by index rather than tied to any specific one — there's no real
// connection between a given screenshot and a given signal example,
// they're just proof, laid over the corner of each card.
// Disabled for now (sizing/placement not finalized) — re-enable by
// uncommenting this and the two <img> usages below.
// const proofShots = [
//   '/proof-win-1.jpeg',
//   '/proof-win-2.jpeg',
//   '/proof-win-3.jpeg',
        ...
        <div className="marquee-track">
          {row1.map((r, i) => (
            <div key={i} className="testimonial-card">
              {/* Disabled for now — sizing/placement not finalized, see proofShots comment above.
