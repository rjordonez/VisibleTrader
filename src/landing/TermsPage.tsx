  ...
  return (
    <>
      <div className="blog-content legal-content">
        ...
        <p>
          These Terms of Service ("Terms") form a binding agreement between you and Envy Labs LLC, a California
        ...
        <p>
          To the fullest extent permitted by law, in no event will VisibleTrader or Envy Labs LLC be liable for any
        ...
        <h2>14. Indemnity</h2>
        <p>
          You will defend, indemnify, and hold harmless VisibleTrader and Envy Labs LLC from and against any claim,
        ...
        <h2>24. Contact</h2>
        <p>
          Envy Labs LLC, doing business as VisibleTrader. Email visibletradehq@gmail.com. Our mailing address is
